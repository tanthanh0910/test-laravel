        ...
        <div class="card card-container form-mobile">
            <form class="form-auth mt-4" method="post" spellcheck="false" autocomplete="on" action="{{ route('register') }}">
                ...
                <div class="form-group {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                    <label for="password-sign-in">Password confirmation</label>
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control form-custom"
                ...
                <div style="display: flex">
                    <div>
                        <a style="color: black" href="{{ route('login') }}" data-toggle="modal">Already have account?</a>
                    </div>
                </div>
